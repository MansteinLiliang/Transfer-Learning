...
if args.prompt_id:
    from keras_demo.asap_evaluator import Evaluator
...
from keras_demo.optimizers import get_optimizer
...
from keras_demo.models import create_model
